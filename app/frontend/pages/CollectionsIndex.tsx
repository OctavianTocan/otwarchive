  ...
  return (
    <AppShell>
      ...
      <div className="mx-auto max-w-[1180px] px-4 md:px-5 pt-6 pb-16">
        <main>
          <h2 className="font-semibold text-base">{context.heading || context.ownerName || "Collections"}</h2>
          ...
          <ol className="flex flex-col divide-y divide-border">{collections.map((c) => <li key={c.id}><CollectionCard c={c} /></li>)}</ol>
          {pagination.pages > 1 && (
